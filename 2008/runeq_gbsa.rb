...
##if [ $# -lt 2 ]; then
#echo "usage: runeq.sh firstAA secondAA"
#exit 1
#fi
#
%x{cp ../2min/min#{aa1}#{aa2}.rst .}
...
if ARGV[2] == "2"
%x{
n1ge -mpi 8 -N AMB_eq#{aa1}#{aa2} -g 1B070296 -q bes2 "sander -O -i eq.in -o eq#{aa1}#{aa2}.out -p #{aa1}-#{aa2}_no.top -c min#{aa1}#{aa2}.rst -r eq#{aa1}#{aa2}.rst -ref min#{aa1}#{aa2}.rst -x eq#{aa1}#{aa2}.mdcrd"
}
else
%x{
