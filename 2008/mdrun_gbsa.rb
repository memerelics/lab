...
aa1 = ARGV[0]; aa2 = ARGV[1]
  %x{cp ../3eq/eq#{aa1}#{aa2}.rst .} if File.exists?("eq#{aa1}#{aa2}.rst") == false
  ...
  if ARGV[2] == "2"
    %x{
      n1ge -mpi 8 -N AMB_md#{aa1}#{aa2} -g 1B070296 -q bes2 "sander -O -i md.in -o md#{aa1}#{aa2}.out -p #{aa1}-#{aa2}_no.top -c eq#{aa1}#{aa2}.rst -r md#{aa1}#{aa2}.rst -ref eq#{aa1}#{aa2}.rst -x md#{aa1}#{aa2}.mdcrd"
    }
  else
    %x{
